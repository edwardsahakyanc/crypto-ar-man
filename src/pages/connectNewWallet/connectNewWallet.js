    ...
    return (
        <Container className="mt-5">
            <ConnectedWalletsContainer>
                <Route path="/create-new-wallet/step1">
                    <StepTitle>
                ...
                <Route path="/create-new-wallet/step2">
                    <StepTitle>
                        Wallet Connect
                    </StepTitle>
                    <WalletsContainer>
                ...
                <Route path="/create-new-wallet/step3">
                    <StepTitle>
                ...
                <Route path="/create-new-wallet/step4">
                    <StepTitle>
                        Connection Complete!
                    </StepTitle>
                    <WalletsContainer>
                    ...
                    <CreateNewWallet text="Share Link!" pathTo="finish"/>
                </Route>
            </ConnectedWalletsContainer>
        </Container>
    )
